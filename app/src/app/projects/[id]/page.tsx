...
export async function generateMetadata(
  ...
  return {
    title: `${project.title} | Balaraj R`,
    description: project.description,
    keywords: project.keywords,
    alternates: {
      canonical: `https://balaraj.vercel.app/projects/${params.id}`,
    },
    openGraph: {
      title: project.title,
      description: project.description,
      images: [{ url: `https://balaraj.vercel.app${project.image}` }],
      url: `https://balaraj.vercel.app/projects/${params.id}`,
      type: "article",
    },
    twitter: {
      ...
      title: project.title,
      description: project.description,
      images: [`https://balaraj.vercel.app${project.image}`],
    },
  };
}
